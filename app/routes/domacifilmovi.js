...
export default class DomacifilmoviRoute extends Route {
  model() {
    ...
    localStorage.setItem("9.df","ans1");
    ...
    return {
      data: [
        ...
        {
          id: 3,
          question: '3. Ljubav i moda iz 1990. godine je prvi srpski film u boji?',
          answer1: 'Tačno',
          answer2: 'Netačno',
        ...
        {
          id: 4,
          question: '4. Technotise: Edit i ja je prvi dugometražni srpski animirani film?',
          answer1: 'Tačno',
          answer2: 'Netačno',
        ...
        {
          id: 5,
          question: '5. Balkanski špijun je najpoznatiji film reditelja Ivana Nikolića?',
          answer1: 'Tačno',
          answer2: 'Netačno',
        ...
        {
          id: 9,
          question: '9. Dragan Bjelogrlić nije režirao film "Montevideo, Bog te video"?',
          answer1: 'Tačno',
          answer2: 'Netačno',
        ...
        {
          id: 10,
          question: '10. Čudna devojka iz 1935. je prva srpska zvučna filmska komedija?',
          answer1: 'Tačno',
          answer2: 'Netačno',
        ...
        {
          id: 12,
          question: '12. Lepa sela lepo gore je najgledanija srpska drama svih vremena?',
          answer1: 'Tačno',
          answer2: 'Netačno',
