      ...
      data: [
        {
          ...
          answer2:
            'Međusobno podudarne odgovarajuće stranice i uglove',
...

        {
          ...
          answer1: 'Sabiranje, oduzimanje, množenje i deljenje polinoma i brojeva',
        ...
        },
        {
          ...
          answer1:
            ...
            answer4: 'Riemannova hipoteza je jedan od najpoznatijih nerešenih problema u matematici, koji tvrdi da sve nule Riemannove delta funkcije imaju realan deo jednak 1/2',
            answer2: 'Riemannova hipoteza je jedan od najpoznatijih nerešenih problema u matematici, koji tvrdi da sve nule Riemannove zeta funkcije imaju realan deo jednak 1/3',
            answer3: 'Riemannova hipoteza je jedan od najpoznatijih nerešenih problema u matematici, koji tvrdi da sve nule Riemannove delta funkcije imaju realan deo jednak 1/3',
        },
        {
          id: 5,
        ...
        {
          id: 10,
          question: '10. Ukoliko sa a obeležavamo dužinu osnovne ivice, sa H dužinu visine kvadra, sa B površinu baze kvadra, a sa M obeležavamo površinu omotača kvadra, koja je formula za izračunavanje telesne dijagonale kvadra?',
          answer2: 'a*sqrt(3)',
        ...
        },
        {
          id: 12,
          question:
            '12. Koja je vrijednost π (pi) zaokružena na pet decimala?',
          answer4: '3.14159',
          answer1: '3.14158',
          answer2: '3.14155',
          answer3: '3.14157',
