    ...
    return {
      data: [
        ...
        },
        {
          ...
          answer1: 'DNK određuje isključivo boju očiju, kose i kože.',
          answer2:
            'DNK (deoksiribonukleinska kiselina) nosi genetičku informaciju i kontrolira procese u ćelijama',
          answer3: 'DNK ne postoji u ljudskom organizmu',
          answer4: 'Ne znam',
        },
        {
          id: 4,
          question:
            '4. Mitoza je proces deobe ćelija kojim se formiraju dve identične ćelije sa istim brojem hromozoma kao i početna ćelija',
        ...
        },
        {
          id: 7,
          question:
            '7. Fotosintetski pigmenti su hemijski spojevi koji apsorbuju svetlost i omogućavaju biljkama da obavljaju fotosintezu. Najvažniji fotosintetski pigment nije hlorofil.',
          answer1: 'Tačno',
          answer2: 'Netačno',
        },
        {
          ...
          answer1: 'Biljke se ne razmnožavaju',
          answer2:
        ...
        },
        {
          id: 9,
          question:
            '9. Enzimi su proteini koji katalizuju (ubrzavaju) hemijske reakcije u ćelijama, omogućavajući im da se odvijaju pri optimalnim brzinama',
          answer1: 'Tačno',
          answer2: 'Netačno',
        },
        {
        ...
        },
        {
          id: 11,
          question:
            '11. Ekologija je naučna disciplina koja proučava odnose između organizama i njihove okoline',
          answer1: 'Tačno',
          answer2: 'Netačno',
        },
        {
